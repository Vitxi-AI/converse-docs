...
To use the  Converse APIs, You need to insure that you have following details with you.

A. **UUID** - You can get the UUID from the local web session storage as show in the image below:

![251 Website Contacts Meta Data  Converse Resource C 1 Pn](/images/api-references/website-contact-metadata/251.website_contacts__meta_data__Converse_resource_c-1.png)
...
https://page. Converse.com/BotId/CustomerId
...
<script id=" Converse-messenger-widget" src="https://cdn. Converse.com/ Converse.js" defer>BotId,CustomerId</script>
...
`PUT` `https://api.v7. Converse.com/inbox/direct/lead`
...
`GET` `https://api.v7. Converse.com/inbox/direct/chats`
    ...
    "data": [
        {
            ...
            "lastMessage": {
                ...
                "by": "bot",
                "text": "Welcome to  Converse. I am here to help you."
            },
...
If you have any questions, you can look into our repository of FAQs, most likely, you will find your answer here, If not, write us at [support@ Converse.com](mailto:support@ Converse.com).