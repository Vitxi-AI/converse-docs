...
This API endpoint allows you to update the status of users in your  Converse application.

**Endpoint URL:** `https://api.v7. Converse.com/inbox/users/status-update`
...
```
curl 'https://api.v7. Converse.com/inbox/users/status-update' \
  -X 'PUT' \
