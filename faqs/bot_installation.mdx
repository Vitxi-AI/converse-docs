...
<AccordionGroup>
  ...
  <Accordion title="How to install a bot on wordpress website">
    ...
    6. Once your Plugin is activated, paste the Bot Penguin API key in the Box named " Converse Snippet" that you Copied from your  Converse account.
  ...
  <Accordion title="How to resolve latency issues on my website when I have the chatbot installed">
    ...
    <img
      src="/images/how-botpenguin-works/bot-installation-faq/204.bot_installation_faqs__Converse_resource_centre-1.png"
      alt="204 Bot Installation Faqs  Converse Resource Centre 1 Pn"
      title="204 Bot Installation Faqs  Converse Resource Centre 1 Pn"
      style={{ width:"77%" }}
    />
