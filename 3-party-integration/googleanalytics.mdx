---
title: "Integrate  Converse with Google Analytics"
description: "This page contains step by step information on how you can integrate the Google Analytics with the  Converse."
---

#### **Integration of Google Analytics with  Converse**

Google Analytics is a powerful tool to measure and analyze user interactions, such as the number of clicks and views, on your chatbot. Integrating Google Analytics with your  Converse chatbot enables you to track these metrics and optimize performance.

Follow these steps to integrate Google Analytics with  Converse:

**Step 1: Log in to  Converse**

1. Navigate to your [ Converse account](https://www. Converse.com/).
...
To connect Google Analytics to your  Converse account, you need the Measurement ID from your Google Analytics account. Follow these steps to get it:
...
**Step 4: Connect Google Analytics to  Converse**

1. Go back to the  Converse integration page where you clicked **Connect** for Google Analytics.
