---
title: "Integrate  Converse with Google Contacts"
description: "This page includes all the necessary information on how you can integrate the Google contacts with  Converse in details"
---

### **Use of Google Contacts?**

 Converse integrates with Google Contacts to streamline contact management and improve customer interaction. By syncing  Converse’s AI-powered chatbot with Google Contacts, businesses can automatically capture, update, and manage contact information in real-time. This integration allows for seamless data syncing, ensuring that customer profiles are always up-to-date and improving communication and follow-up processes.
...
### **Integrate  Converse with Google Contacts**

 1. **Login to  Converse:**
    - Start by logging into your  Converse account.
 2. **\
    Navigate to the Bot:**
 ...
 6. **Login to Google Account:**
    - You will be prompted to log into your Google account. Ensure you use the Google account you want to link with  Converse.
 7. **\
    Grant Permissions:**
    - Follow the on-screen instructions to grant  Converse the necessary permissions to access your Google Contacts.
 8. **Map the Questions:**
...
11. **Check the Contact Section:**
    - In the "Contact" section of your  Converse dashboard, you will see the demo leads created by the integration.
