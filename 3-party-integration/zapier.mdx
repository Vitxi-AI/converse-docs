---
title: "Integrate  Converse with Zapier"
description: "This page contains the step wise tutorial for the integration of Zoho CRM with  Converse."
---

### **What is Zapier.**

Zapier is an automation tool which helps making a connecting between apps. You can set  Converse and apps in zapier as triggers and actions.

---

### **Benifits of using Zapier:**

- **Seamless Automation:** Instantly connect  Converse with thousands of apps without custom coding.
...
### **Steps to use  Converse with Zapier**

 1. Log in to your  Converse account and select a bot you wish to integrate with Zapier.
 ...
 4. Then go to Zapier website.
    ...
    [ Converse Integrations | Connect Your Apps with ZapierZapier](https://zapier.com/apps/ Converse/integrations)
 5. Here you can see all the supported Triggers and Actions that are available to be used with  Converse.
...
11. Select  Converse from the list as trigger.
12. Then select a trigger event from the list of available events.
13. After that click on "Sign In" to connect  Converse.
14. \
    When you click on sign in, a pop will be opened to give zapier access to your  Converse account.
15. Select the platform / bot channel for which you want to use zapier
16. Then enter the API Key which is available in Developers section inside Access Token in  Converse.
17. Then enter the Bot Id, you can click on "edit" in Zapier Integration Page to get Bot Id for the same.
18. And click "Yes Continue with  Converse".
...
**Similarly you can use other apps as TRIGGERS and  Converse as ACTION**
