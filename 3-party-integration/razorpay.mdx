---
title: "Integrate  Converse with Razorpay"
description: "This page contains al the necessary information on how you can interate the Razorpay with Botepenguin"
---

### **Prerequisites**

To successfully integrate Razorpay with  Converse, you will need:

- A ** Converse** account.
- A **Razorpay** account.
- A **WhatsApp bot**

This integration enables your WhatsApp bot created on  Converse to collect payments via Razorpay.

#### **Step 1: Login to  Converse and Select WhatsApp Bot**

1. Go to [ Converse](https://www. Converse.com/) and log into your account.
...
To connect Razorpay with  Converse, you need the **Client ID** and **Client Secret** from your Razorpay account.
...
#### **Step 4: Connect Razorpay to  Converse**
...
4. Go back to  Converse and copy the **Webhook URL** from the integration settings.
...
1. Navigate back to your  Converse bot editor.
2. \
...
Your  Converse WhatsApp bot is now successfully integrated with Razorpay. You can collect payments seamlessly and track payment events through the configured webhooks. This integration ensures a smooth payment experience for your users directly through WhatsApp.   